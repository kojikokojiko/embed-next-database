...
// // ユニオン型
// 例えば、上記のPropsの定義において、knowledge_urlsというプロパティは、urlプロパティを持ったオブジェクトの配列またはnullという2つの異なる型を持っています。|を使ってこれらの型を組み合わせることで、ユニオン型を定義しています。

// ユニオン型は、異なる型の値を受け入れる柔軟性があり、型の組み合わせによりより精緻な型を定義することができます。これにより、より強力な型チェックを行いながら、より柔軟なデータの扱いを可能にします。
type Props = {
  knowledge_urls:
    | {
        url: string
